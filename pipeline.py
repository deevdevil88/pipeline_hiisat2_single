...
@follows(mkdir("results/fastqc"))
@transform(
    symlink_fastq, regex(r"data/fastq/(.*).fastq.gz"), r"results/fastqc/\1_fastqc.html"
)
...
@follows(mkdir("results/samtools/idxstats"))
@transform(
    hisat2_on_fastq,
    regex(r"results/hisat2/(.*).bam"),
    r"results/samtools/idxstats/\1",
)
...
@follows(mkdir("results/samtools/flagstat"))
@transform(
    hisat2_on_fastq,
    regex(r"results/hisat2/(.*).bam"),
...
@follows(mkdir("results/picard/CollectAlignmentSummaryMetrics"))
@transform(
    hisat2_on_fastq,
    regex(r"results/hisat2/(.*).bam"),
    r"results/picard/CollectAlignmentSummaryMetrics/\1",
)
...
# only needed for paired-end liibraries not single end

#@follows(mkdir("results/picard/CollectInsertSizeMetrics"))
#@transform(
#    hisat2_on_fastq,
#    regex(r"results/hisat2/(.*).bam"),
#    r"results/picard/CollectInsertSizeMetrics/\1",
#)
...
@follows(mkdir("results/picard/CollectRnaSeqMetrics"))
@transform(
    hisat2_on_fastq,
    regex(r"results/hisat2/(.*).bam"),
    r"results/picard/CollectRnaSeqMetrics/\1",
)
def picard_rnaseq_metrics_on_bam(infile, outfile):
    """
    Run `picard CollectRnaSeqMetrics` on the BAM files produced by HISAT2.
    """
    ...
    statement = """
        picard CollectRnaSeqMetrics
            -I %(infile)s
            -O %(outfile)s
            -REF_FLAT %(picard_refflat)s
            -STRAND %(picard_strand_spec)s
            --VALIDATION_STRINGENCY %(picard_stringency)s
            2> %(outfile)s.log
        """
...
def multiqc_bam(infiles, outfile):
    ...
    statement = """
        multiqc
            ...
            -o results/reports/multiqc
            results/hisat2
            results/samtools/idxstats
            results/samtools/flagstat
            results/picard/CollectAlignmentSummaryMetrics
            results/picard/CollectRnaSeqMetrics
